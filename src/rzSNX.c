...
void rzSNX(double *absz, double *M, double *RV, int *n, int *p, int *k, int *N, double *yVec, double *XVec, double *BVec, double *psiVec, double *GVec){
 ...
 for(iN = 0; iN < *N; iN++){	// iN = 0;
  ...
  for(i = 0; i < *n; i++){
   ...
   M[iN * *n + i] = Vi[0] * tpsiinvGymBXDouble[0];
